   ...
   <!-- Navbar End -->
    ...
    <!-- off canvas start -->
      ...
      <form method="POST">
        ...
        style="margin-left:0px;width:200px;height:36px;margin-top:0px;margin-right:5px; border-radius: 10px;  background-color: rgb(22, 72, 172);">
         ...
         style="margin-left:0px; border-radius: 10px;  background-color: rgb(22, 72, 172);">
            <option disabled selected>Year</option>
             <option value="2020">2020</option>
             <option value="2021">2021</option>
             <option value="2022">2022</option>
         </select>
             <input style="background:#48e772;
              border-radius:10px;
              border:none;
              outline:none;
              color:#fff;
      ...
      <button onclick="viewInstructorWiseChosenCourse()" style="height: 46px;width: 100px;margin-left:50px;display:inline-block; border-radius: 10px; border: none;outline: none;background:#074fcc;color: #fff;font-size: 14px;letter-spacing:2px;text-transform: uppercase;cursor:pointer;font-weight: bold;">
        view</button>
      </div>
