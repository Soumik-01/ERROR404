...
<div class="background">
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="schoolID" class="select">
     ...
     <input style="background:#2be14f;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
     ...
     type="submit" name="submit" value="Submit"/>
        ...
        border: none;outline: none;background:#2c39f2;color: #fff;font-size: 14px;letter-spacing:2px;
