...
<div class="background">
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="departmentID" class="select">
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="year" class="select">
       ...
       <input style="background:#24dc58;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        border: none;outline: none;background:#3d25d7;color: #fff;font-size: 14px;letter-spacing:2px;
