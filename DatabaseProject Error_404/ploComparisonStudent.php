...
<div class="background">
     ...
     <input style="background-color:#82cba1;height:36px;border: 1px solid;cursor: pointer;border-radius: 5px;
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="year" class="select">
       ...
       <input style="background:#1ddf2d;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        border: none;outline: none;background:#283bdd;color: #fff;font-size: 14px;letter-spacing:2px;
