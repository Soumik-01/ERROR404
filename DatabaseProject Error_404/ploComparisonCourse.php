...
<div class="background">
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="courseID" class="select">
     ...
     <select style="margin-left:10px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="year" class="select">
       ...
       <input style="background:#2fe54d;border-radius:10px;border:none;outline:none;color:#fff;font-size:14px;letter-spacing:2px;
        ...
        border: none;outline: none;background:#2b61e9;color: #fff;font-size: 14px;letter-spacing:2px;
