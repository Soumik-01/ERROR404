...
<html lang="en">
  ...
  <body>
    ...
    <div class="rectangle"><p class=text_of_headers style="background-color: rgb(18, 94, 174);">Course Outline</p></div>
    <table>
        <tr>
            <th>Course Code</th>
  ...
  <select style="width:200px; margin-top:15px; margin-bottom:15px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="cloCount" class="select">
  ...
  <div class="course_learning_outcome_matrix">
    ...
    <select style="width:200px; margin-top:15px; margin-bottom:15px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="topicNum" class="select">
  ...
  <select style="width:220px; margin-top:15px; margin-bottom:15px; border-radius: 10px;  background-color: rgb(22, 72, 172);" name="assessmentCount" class="select">
  ...
  <input style="margin-bottom:20px; border-radius: 10px;  background-color: rgb(47, 184, 111);" type="submit" value="Submit" name="submit" class="submitButton">
  </form>
