...
<div class="background">
      ...
      <div style="height:80px;"class="row1">
        <form method="POST">
        <input style="background-color:#6698FF;height:50px;border: 1px solid;cursor: pointer;border-radius: 10px;font-size: 14px;letter-spacing:2px;
        ...
        <input style="background:#0ad43c;border-radius:10px; border:none;outline:none;color:#fff;font-size:14px;
      ...
      <div style="display:flex;justify-content:space-around" class="row2">
        <button onclick="ploAnalysisWithDepartmentAverage()" style="width:300px;margin-left:0px; border-radius: 10px;  background-color: rgb(22, 72, 172);" class="School-wise">PLO Analysis with Department Average</button>
        <button onclick="ploAnalysisWithProgramAverage()" style="width:300px; border-radius: 10px;  background-color: rgb(22, 72, 172);" class="Department-wise">PLO Analysis with Program Average</button>
        <button onclick="ploAnalysisWithSchoolAverage()" style="width:300px; border-radius: 10px;  background-color: rgb(22, 72, 172);" class="Program-wise">PLO Analysis with School Average</button>
      </div>
